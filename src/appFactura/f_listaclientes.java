...
public class f_listaclientes extends JDialog {
	...
	private void actualizalista(){
		try {
		     sentencia.executeQuery("select id_cli,concat(RAZON_SOCIAL_CLI,' ',NOMBRE_APELLIDO_CLI) as elcliente from clientes where concat(RAZON_SOCIAL_CLI,' ',NOMBRE_APELLIDO_CLI) like '"+TxtCliente.getText()+"%' order by elcliente");

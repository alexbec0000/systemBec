...
public class f_listavendedores extends JDialog {
	...
	private void actualizalista(){
		try {
		     sentencia.executeQuery("select id_ven,concat(USUARIO_VEN,' ',NOMBRE_APELLIDO_VEN) as elvendedor from vendedores where concat(USUARIO_VEN,' ',NOMBRE_APELLIDO_VEN) like '"+TxtVendedor.getText()+"%' order by elvendedor");
	...
	private void seleccionar(){
		if (JTable.isCellSelected(JTable.getSelectedRow(), 0)==false){
			JOptionPane.showMessageDialog(null,"¡Seleccione un Vendedor de la lista!","Error de selección",2);
		}
		else {

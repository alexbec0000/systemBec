...
public class Vendedores extends javax.swing.JFrame {
    ...
    String[] cabecera = {"Nº","Código", "CI", "Nombres", "Direccion", "Tlf.", "Celular", "Comision", "E-Mail"};
    String[][] data = {};
    ...
    public void Actualizar_Tabla()
    {
        ...
        for(int i=0; i < n; i++)
        {
            ...
            float comision = objArreglo.getVendedor(i).getComision();
            String mail = objArreglo.getVendedor(i).getMail();

            //Insertando la indormacion en la tabla
            Insertar (i+1, codigo,CI, nombres, direccion, telefono, celular, comision, mail);
        }//Fin del for
    }
    ...
    public  void Insertar(int  num, String codigo,String CI, String nombres, String direccion, String telefono, String celular, float comision, String mail)
    {

        //Llenando la fila de la tabla
        Object fila [] = {num, codigo,CI, nombres, direccion, telefono, celular, comision, mail};
    ...
    public void Modificar()
    {
        ...
        if(dato.equalsIgnoreCase(""))
        {
            if(codigo.equalsIgnoreCase(""))
            {
                ...
                float comision = Float.parseFloat(jTxtComision.getText());
                ...
                objVendedor = new cls_vendedor (codigo, CI, nombres, direccion, telefono, celular, comision, mail, obs, foto);
        ...
        else mensaje ("Debe llenar los campos correspondientes del vendedor que desea modificar");
    ...
    public void Imprimir_Datos(int pos)
    {
        ...
        float comision = objVendedor.getComision();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "INGRESAR DATOS DEL VENDEDOR: ", 0, 0, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTxtDireccion, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jBtnModificar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
    ...
    private void jBtnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGrabarActionPerformed
       ...
       //Se leen los datos de entrada de los text file
        ...
        if(objArreglo.Buscar(objVendedor.getCodigo())!= -1)
            ...
            objVendedor = new cls_vendedor (cod, CI, nombres, direccion, telefono, celular, comision, mail, obs, foto);
            //Se agrega el objeto al arreglo
            objArreglo.Agregar(objVendedor);
            //Insertando la ifnromacion en la tabla
            Insertar (0, codigo,CI, nombres, direccion, telefono, celular, comision, mail);
            //Limpiando las entradas
            Limpiar_Entradas();

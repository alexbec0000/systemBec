  ...
  extends AbstractTableModel
{
 ...
 /*  private String[] columnNames = { "Cantidad",        //0
                                    "Código principal", //1
                                    "Código auxiliar", //2
                                    "Descripción",     //3
                                    "Precio Unitario", //4
  ...
  public FacturaModel(Producto prod, Double cantidad)
  {
  ...
  public void setValueAt(Object value, int row, int col)
  {
    ...
    else if (col == 7)
    {
      ...
      {
        System.out.println("Valor no permitido Se ha producido un error "+ex.getMessage());
      }
  ...
  public void addRow(Producto producto)
  {
    ...
    {
      System.out.println("Error calculaImpuestosProducto: "+ ex);
    }
    ...
    throws SQLException, ClassNotFoundException
  {
    ...
    if (!impuestosProducto.isEmpty())
    {
      ...
      for (ImpuestoProducto ip : impuestosProducto)
      {
        ...
        //ImpuestoValor iv = new ImpuestoValorSQL().obtenerIVA();
  ...
  {
    BigDecimal total = BigDecimal.ZERO;
    BigDecimal porcentage = BigDecimal.ZERO;
    BigDecimal BaseImponible = BigDecimal.ZERO;
    for (SubtotalImpuesto s : this.listaIva12)
    {
      BaseImponible = BaseImponible.add(s.getBaseImponible());
      porcentage = s.getPorcentaje();
    }
    total = BaseImponible.multiply(porcentage);
    return total;
  }
